...
$\forall x\in]0; 1]$, $\ln x <0\implies -\ln x >0$ donc $\forall x\in]0; 1], f'(x)\leq 0$

$\forall x\in[1; +\infty[$, $\ln x >0\implies -\ln x <0$ donc $\forall x\in]1; +\infty[, f'(x)\geq 0$

\textbf{En résumé}
\textcolor{green}{
\begin{itemize}
\item $\forall x\in]0; 1], f'(x)\leq 0$
\item $\forall x\in]1; +\infty[, f'(x)\geq 0$
\end{itemize}
}
