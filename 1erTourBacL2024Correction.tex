...
\begin{tikzpicture}
\tkzTabInit{$x$/1,$f'$/1,$f$/2}{$0$,$1$,$+\infty$}
\tkzTabLine{,+,z,-}
\tkzTabVar{-/$-\infty$,+/$1$,-/$0$}
\end{tikzpicture}
\end{itemize}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{courbe1-2024.png}
...
\int_{1}^{e}f(x)&=\left[F'(x) \right]_{1}^{e}\\
 								...
 								&=\frac{3}{2}
\end{align*}
$$\textcolor{green}{\boxed{\int_{1}^{e}f(x)=\frac{3}{2}\quad \text{cm}^{2} }}$$
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{aire2024.png}
\caption{Courbe de (Cf)}
\label{fig:monimage}
\end{figure}
\end{itemize}
